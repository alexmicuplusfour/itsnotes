...
const FEATURES = [
  ...
  { feature: AUTO_TAG_FEATURES.TASK_COMPLETED, id: 'task-completed-autotag-toggle', icon: 'check_circle', title: 'Task List Completed', description: 'When all tasks in a note are checked off, suggest or apply tags after a short delay.', mode: true, tags: true },
